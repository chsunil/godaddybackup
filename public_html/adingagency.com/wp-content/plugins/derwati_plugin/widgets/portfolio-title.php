 ...
 * @since 1.1.0
 */
class Derwati_PortfolioTitle extends Widget_Base {
	...
	public function get_name() {
		return 'derwati-portfolio-title';
	}
	...
	public function get_title() {
		return __( 'Derwati Portfolio Title', 'derwati_plg' );
	}
	...
	protected function render() {
		...
		<<?php echo $htag ?> class="content-title"><?php the_title(); ?></<?php echo $htag ?>>
	<?php }

 ...
 * @since 1.1.0
 */
class Derwati_OtherPortfolio extends Widget_Base {
	...
	public function get_name() {
		return 'derwati-other-portfolio';
	}
	...
	public function get_title() {
		return __( 'Derwati Related Portfolios', 'derwati_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Related Portfolio Settings', 'derwati_plg' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' =>  __( 'Other Portfolio', 'derwati_plg' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' =>  __( 'See our other portfolio', 'derwati_plg' ),
			]
		);
		...
		$this->add_control(
            'port_post',
            [
                'label' => __( 'Related Portfolio to show', 'derwati_plg' ),
		...
		$this->add_control(
			'port_column',
			[
				'label' => __( 'Related Portfolio Columns', 'derwati_plg' ),
		...
		$this->start_controls_section(
			'text_section',
			[
				'label' => __( 'Subtitle Settings', 'derwati_plg' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'title_col',
			[
				'label' => __( 'Portfolio Title Color', 'derwati_plg' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'cattitle_col',
			[
				'label' => __( 'Portfolio Category Color', 'derwati_plg' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'mask_color_opacity',
			[
				'label' => __( 'Mask Opacity (on hover)', 'derwati_plg' ),

(function($) {
    ...
    $("#elementor-preview-iframe").on("load", function() {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/derwati-mason-gallery.default', function($scope) {
			 $scope.find('.mason-gallery').imagesLoaded(function() { 
			 	$scope.find('.mason-gallery').isotope();
			 });
		});
		elementorFrontend.hooks.addAction('frontend/element_ready/derwati-post-four.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/derwati-testimonial.default', function($scope) {
		...
		//for post slider
        elementorFrontend.hooks.addAction('frontend/element_ready/derwati-post-slider.default', function($scope) {
        ...
        //for menu
        elementorFrontend.hooks.addAction('frontend/element_ready/derwati-menu.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/derwati-portfolio-info.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/derwati-portfolio.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/derwati-portfolio-masonry.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/derwati-sidebar.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/derwati-texticon-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
		
		elementorFrontend.hooks.addAction('frontend/element_ready/derwati-team-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});

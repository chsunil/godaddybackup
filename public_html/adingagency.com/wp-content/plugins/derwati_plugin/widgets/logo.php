 ...
 * @since 1.1.0
 */
class Derwati_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Logo/Branding', 'derwati_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Logo Settings', 'derwati_plg' ),
			]
		);
		...
		$this->add_control(
			'height',
			[
				'label' => __( 'Logo Image max Height', 'derwati_plg' ),
		...
		$this->start_controls_section(
			'logo_settings',
			[
				'label' => __( 'Logo Setting', 'derwati_plg' ),

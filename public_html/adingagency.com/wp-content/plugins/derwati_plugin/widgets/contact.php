 ...
 * @since 1.1.0
 */
class Derwati_Contact extends Widget_Base {
	...
	public function get_title() {
		return __( 'Derwati Contact Form Shortcode', 'derwati_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'shortcode',
			[
				'label' => __( 'Insert your contact form shortcode here', 'derwati_plg' ),
		...
		$this->start_controls_section(
			'form_settings',
			[
				'label' => __( 'Form Setting','derwati_plg' ),
	...
	protected function render() {
		...
		?>
		<div class="derwati-contact-shortcode"><?php echo $shortcode; ?></div>
		<?php
	}

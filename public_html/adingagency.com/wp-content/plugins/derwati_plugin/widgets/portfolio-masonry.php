 ...
 * @since 1.1.0
 */
class Derwati_PortfolioMasonry extends Widget_Base {
	...
	public function get_name() {
		return 'derwati-portfolio-masonry';
	}
	...
	public function get_title() {
		return __( 'Derwati Portfolio Masonry', 'derwati_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'portfolio_styling',
			[
				'label' => __( 'Portfolio Item Settings.', 'derwati_plg' ),
		...
		$this->add_responsive_control(
			'img_padding',
			[
				'label' => __( 'Image Padding', 'derwati_plg' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'img_margin',
			[
				'label' => __( 'Image Margin', 'derwati_plg' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [

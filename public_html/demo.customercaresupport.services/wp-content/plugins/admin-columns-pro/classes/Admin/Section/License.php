		...
		if ( $this->is_network_activated && ! is_network_admin() ) {
			...
			<form id="licence_activation" action="" method="post">
				...
				<?php else : ?>
					...
					<input type="password" value="<?= $key ? $key->get_value() : ''; ?>" name="license" size="30" placeholder="<?php echo esc_attr( __( 'Enter your license code', 'codepress-admin-columns' ) ); ?>">

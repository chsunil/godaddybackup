...
?>
	...
	<?php wp_head(); ?>
	<!-- Global site tag (gtag.js) - Google Ads: 666595491 --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-666595491"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-666595491'); </script>
...
if ( is_page(25156) ) {
    ...
    ?>
<scipt>
<!-- Event snippet for Lead conversion page --> <script> gtag('event', 'conversion', {'send_to': 'AW-666595491/H6ugCNSzk8QBEKPh7b0C'}); </script>
<?php
} else {
